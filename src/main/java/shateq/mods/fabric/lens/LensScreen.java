...
public class LensScreen extends Screen {
    ...
    public void render(PoseStack poseStack, int i, int j, float deltaTime) {
        if (!this.checkToClose()) {
            ...
            drawCenteredString(poseStack, this.font, Component.nullToEmpty("Detailed info about your lens..."), this.width / 2, this.height / 2 + 12, WHITE);
